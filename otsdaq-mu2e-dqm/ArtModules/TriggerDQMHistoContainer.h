#ifndef _TriggerDQMHistoContainer_h_
#define _TriggerDQMHistoContainer_h_
...
namespace ots {
  ...
  class TriggerDQMHistoContainer {
  public:
    TriggerDQMHistoContainer(){};
    virtual ~TriggerDQMHistoContainer(void){};
